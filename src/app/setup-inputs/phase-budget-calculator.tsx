...
> = {
  ...
  p1: {
    shell: "border-[#ff332b]",
    header: "bg-[#ff332b] text-white",
    badge: "bg-white text-[#ff332b]",
    tableHead: "bg-[#fff0ef] text-[#8f1d18]",
    total: "bg-[#fff0ef]",
  },
  p2: {
    shell: "border-[#315b8d]",
    header: "bg-[#315b8d] text-white",
    badge: "bg-white text-[#315b8d]",
    tableHead: "bg-[#eef5ff] text-[#243f66]",
    total: "bg-[#eef5ff]",
  },
  p3: {
    shell: "border-[#7c4f18]",
    header: "bg-[#7c4f18] text-white",
    badge: "bg-white text-[#7c4f18]",
    tableHead: "bg-[#fff6e8] text-[#5f3b10]",
    total: "bg-[#fff6e8]",
  },
  p4: {
    shell: "border-[#2f6d58]",
    header: "bg-[#2f6d58] text-white",
    badge: "bg-white text-[#2f6d58]",
    tableHead: "bg-[#edf8f3] text-[#1f4d3d]",
    total: "bg-[#edf8f3]",
  },
  p5: {
    shell: "border-[#6d527d]",
    header: "bg-[#6d527d] text-white",
    badge: "bg-white text-[#6d527d]",
    tableHead: "bg-[#f7f0fb] text-[#4f3c5c]",
    total: "bg-[#f7f0fb]",
  },
  p6: {
    shell: "border-[#4b5563]",
    header: "bg-[#4b5563] text-white",
    badge: "bg-white text-[#4b5563]",
    tableHead: "bg-[#f3f4f6] text-[#374151]",
    total: "bg-[#f3f4f6]",
  },
};
